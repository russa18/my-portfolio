...
import workingman from "./workingman.jpg"
            ...
            <div className='about'>
                <div className='about-left'>
                    <div className='ab-left-content'>
                        <h1 className='qual'>Work Experience</h1>
                        <img src={workingman} alt="working-man" className='scholar-img' />
                ...
                <div className='about-right'>
                    <div className='edu'>
                        <h2 className='q-heads'>Company</h2>
                        {WorkExp.map((data, key) => {
                            return <div key={key}>
